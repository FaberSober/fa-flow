...
SELECT 22020001, 13000000, 1, '表单管理', 4, 1, 'mdi:form-select', 1, 1,
       '/admin/flow/manage/form', '2025-12-16 16:00:27', '1', '超级管理员', '192.168.5.88',
       '2025-12-16 16:00:27', '1', '超级管理员', '127.0.0.1', 0
WHERE NOT EXISTS (
...
SELECT 22020002, 10000000, 1, '功能示例', 3, 1, 'mdi:ev-plug-chademo', 1, 1,
       '/admin/flow/view/form', '2025-12-27 22:27:16', '1', '超级管理员', '169.254.143.154',
       '2025-12-27 22:27:15', '1', '超级管理员', '127.0.0.1', 0
WHERE NOT EXISTS (
  SELECT 1 FROM `base_rbac_menu`
